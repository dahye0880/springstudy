...
<%-- spring:hasBindErrors : BindingResult.reject 로 등록된 메세지 출력. --%>
<spring:hasBindErrors name="board">
	<font color="red"><c:forEach items="${errors.globalErrors}" var="error"><spring:message code="${error.code}" /></c:forEach>
